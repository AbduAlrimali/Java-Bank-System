...
public class Client extends Person {
    ...
    //Constructor
    public Client(String name, String national_id, String gender, String birthDate, String birthCountry, String phone, String userName, String email, String password, String address) {
    ...
    public String openAcc(String acc_type){
        Account account = new Account(acc_type);
